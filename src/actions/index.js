...
// Saga action types
const FETCH_EXPENSE_OPTIONS = 'FETCH_EXPENSE_OPTIONS';
const FETCH_EXPENSE_GROUPS = 'FETCH_EXPENSE_GROUPS';
const INSERT_NEW_EXPENSE = 'INSERT_NEW_EXPENSE';
const INSERT_NEW_EXPENSE_GROUP = 'INSERT_NEW_EXPENSE_GROUP';
const UPDATE_EXPENSE_GROUP = 'UPDATE_EXPENSE_GROUP';
